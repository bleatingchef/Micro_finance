...
const OfferCard = ({ icon, title, description }) => {
    return (
        <div className="flex flex-col items-center bg-slate-950 text-white hover:bg-white hover:text-slate-950 hover:border-4 hover:border-slate-950 rounded-3xl p-6 sm:p-8 m-4" style={{ width: '100%', maxWidth: '546px', height: 'auto' }}>
...
const Eligibility = ({ title1, description1, icon1 }) => {
    return (
        <div className="flex flex-col items-start p-6 sm:pl-20 bg-slate-950 text-white rounded-3xl m-4" style={{ width: '100%', maxWidth: '546px', height: 'auto' }}>
            <div className="flex flex-col items-start text-start">
                <h2 className="text-2xl sm:text-3xl font-bold mb-5">{title1}</h2>
                <div className="flex items-center justify-center mb-6 w-full" style={{ height: '0.3rem', backgroundColor: "" }}>
                    <img src={icon1} alt="" className="h-1 w-full max-w-xs" />
                </div>
                <p className='text-base sm:text-lg py-5'>{description1}</p>
            </div>
        </div>
    );
};
...
const Features = () => {
    return (
        <div className="flex flex-col items-center px-4 sm:px-10 md:px-20 py-10">
            <h1 className='text-3xl sm:text-5xl md:text-7xl text-slate-950 font-bold mb-5 text-center'>FEATURES & BENEFITS OF FLEXI PERSONAL LOAN</h1>
            <img src={featureLine} className='mb-6 sm:mb-10' alt="" />
            <p className='text-base sm:text-lg md:text-xl mt-4 sm:mt-10 text-slate-950 mb-6 sm:mb-10 text-center'>Our Flexible Personal Loan Is An Excellent Solution For Both Salaried And Self-Employed Individuals In Need Of Financial Assistance.</p>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 sm:gap-8 mr-6 md:mr-0">
                <OfferCard 
            ...
            <h1 className='text-3xl sm:text-5xl md:text-6xl text-slate-950 mt-12 sm:mt-16 font-bold mb-5 text-start'>FLEXI LOAN ELIGIBILITY CRITERIA AND DOCUMENTATION</h1>
            <img src={featureLine} className='mb-4 sm:mb-8 mt-2' alt="" />
            <p className='text-base sm:text-lg md:text-xl text-slate-950 mb-6 sm:mb-10 text-start'>Learn about the eligibility requirements and necessary documentation for quick loan approval.</p>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 sm:gap-64 md:mr-0 mr-6">
                <Eligibility   
